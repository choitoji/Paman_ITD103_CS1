...
const hashedUsers = usersToInsert.map(user => {
...
mongoose.connect(process.env.MONGO_URI, { useNewUrlParser: true, useUnifiedTopology: true })
    .then(async () => {
        ...
        await deleteAllDocuments(Student);
        await deleteAllDocuments(Faculty);

        await User.insertMany(hashedUsers);
        console.log('Users seeded successfully');

        // Seed data for Faculty
        await Faculty.insertMany(mockDataFaculty);
        console.log('Faculties seeded successfully');

        // Seed data for Student
        await Student.insertMany(mockDataStudent);
